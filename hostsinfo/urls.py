...
from hostsinfo.views import GroupUsersView,DelgroupusersView,AddgroupusersView,updategroupusers,updatehostuser
app_name = 'hostsinfo'
urlpatterns = [
    ...
    path(r'updatehostuser/',updatehostuser,name='updatehostuser'),
